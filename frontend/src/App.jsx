  ...
  return (
    <div>
      <div className="flex min-h-screen relative">
        ...
        {isAuthenticated && (
          <aside
            className={`md:w-60 bg-gray-900 text-white p-4 space-y-4 sticky top-0 h-screen overflow-auto ${
              isSidebarOpen
                ? "fixed inset-0 z-20 w-full md:relative md:w-60 md:block"
                : "hidden md:block"
            }`}
          >
            <div className="flex justify-between items-center mb-5 mt-2 ml-3">
              <div
                className="text-3xl font-bold de text-red-500 hover:scale-105 cursor-pointer"
                onClick={() => {
                  setActiveMenu("board");
        ...
        <main
          className={`flex-1 p-6 bg-gray-700 relative flex flex-col ${
            ...
            <div className="flex justify-end mb-4 relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-gray-900 border border-gray-600 rounded shadow-lg z-10">
                  ...
                  >
                    <LogOut strokeWidth={2.5} className="ml-0.5" size={22} />{" "}
                    LogOut
                  </button>
                </div>
              )}
